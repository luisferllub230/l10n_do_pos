...
class PosOrder(models.Model):
    ...
    def create_from_ui(self, orders, draft=False):
        ...
        for order in self.sudo().browse([o['id'] for o in order_ids]):
            ...
            if order.config_id.invoice_journal_id.l10n_latam_use_documents \
    ...
    def search_paid_order_ids(self, config_id, domain, limit, offset):
        ...
        if pos_config.invoice_journal_id.l10n_latam_use_documents:
            config_ids = self.env['pos.config'].search([('invoice_journal_id.l10n_latam_use_documents', '=', True)]).ids 
