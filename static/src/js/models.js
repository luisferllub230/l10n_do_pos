odoo.define('l10n_do_pos.models', function (require) {
    ...
    const L10nDoPosPosGlobalState = PosGlobalState => class extends PosGlobalState {
        ...
        isCreditNoteMode() {
            ...
            return this.env.pos.config.l10n_latam_use_documents && current_order && current_order._isRefundAndSaleOrder();
        }
    ...
    const L10nDoPosOrder = Order => class extends Order {
        ...
        constructor(obj, options) {
            ...
            if (this.pos.config.l10n_latam_use_documents){
        ...
        export_for_printing() {
            ...
            result.l10n_latam_use_documents = this.pos.config.l10n_latam_use_documents;
