    ...
    const L10nDoPosPaymentScreen = (PaymentScreen) =>
        class extends PaymentScreen {
            ...
            async _finalizeValidation() {
                ...
                var current_order = this.env.pos.get_order();
                if (this.env.pos.config.l10n_latam_use_documents && !current_order.to_invoice && !current_order.ncf) {
            ...
            async addNewPaymentLine({ detail: paymentMethod }) {
                if(this.env.pos.config.l10n_latam_use_documents && paymentMethod && paymentMethod.is_credit_note){
            ...
            _updateSelectedPaymentline(){
                if (this.selectedPaymentLine && 
                    ...
                    this.env.pos.config.l10n_latam_use_documents){
                    this.showPopup('ErrorPopup', {
                        title: _t('Error'), 
